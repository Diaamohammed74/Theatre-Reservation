            ...
            <form action="{{ route('dashboard.time-slots.store') }}" method="post" id="add_form" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="time" class="border form-control" name="start_time" step="2" placeholder="Please enter start time" value="{{ old('start_time') }}">
                        <x-input-error :messages="$errors->get('start_time')" class="mt-2" />
                    </div>
                    <div class="form-group col-md-6">
                        <label class="form-label">End time</label>
                        <input type="time" class="border form-control" name="end_time" step="2" placeholder="Please enter end time" value="{{ old('end_time') }}">
